...
const categoryIconMap = {
  building: (
    <>
      <rect x="5" y="4" width="8" height="16" rx="2" />
      <path d="M13 6h4a2 2 0 0 1 2 2v12" />
      <path d="M8 8h2M8 11h2M8 14h2M15 11h2M15 14h2" />
      <path d="M10 20v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3" />
    </>
  ),
  briefcase: (
    <>
      ...
      <path d="M4 11h16" />
      <path d="M11 11v2h2v-2" />
    </>
  ),
  plane: (
    <>
      <path d="M10.5 13.5 4 15l1.2 2 6.3-1.2L16 20l1.5-.8-2.3-4.7 3.8-.7a1.7 1.7 0 0 0 0-3.4l-3.8-.7L17.5 5 16 4l-4.5 4.2L5.2 7 4 9l6.5 1.5" />
    </>
  ),
  "sun-wave": (
    <>
      <path d="M6 16c1 .8 2 .8 3 0s2-.8 3 0 2 .8 3 0 2-.8 3 0" />
      <path d="M5 19c1 .8 2 .8 3 0s2-.8 3 0 2 .8 3 0 2-.8 3 0" />
      <path d="M12 7v7" />
      <path d="M8.5 7a3.5 3.5 0 1 1 7 0Z" />
      <path d="M17 5.5h.01M19 7.5h.01M17 9.5h.01" />
    </>
  ),
  palm: (
    <>
      <path d="M12 20v-6" />
      <path d="M12 14c0-3 1.8-5.2 4.5-6" />
      <path d="M12 14c0-3-1.8-5.2-4.5-6" />
      <path d="M12 10c1.5-2.2 3.8-3 6.2-2.5" />
      <path d="M12 10C10.5 7.8 8.2 7 5.8 7.5" />
      <path d="M10 20h4" />
    </>
  ),
  lake: (
    <>
      <path d="M4 18c1.2.8 2.4.8 3.6 0s2.4-.8 3.6 0 2.4.8 3.6 0 2.4-.8 3.6 0" />
      <path d="M5 14l4-5 3 3 2-2 5 4" />
      <path d="M9 9.2 11 7l2.4 2.6" />
    </>
  ),
  mountain: (
    <>
      <path d="m3 18 6-8 3 4 2-3 7 7" />
      <path d="m8.5 11.5 1.5-2 1.5 2" />
    </>
  ),
  storefront: (
    <>
      <path d="M5 9.5 6.2 5h11.6L19 9.5" />
      <path d="M5 9.5A2.5 2.5 0 0 0 8 12a2.8 2.8 0 0 0 2-1 2.8 2.8 0 0 0 4 0 2.8 2.8 0 0 0 2 1 2.5 2.5 0 0 0 3-2.5" />
  ...
  leaf: (
    <>
      <path d="M18 5c-6.5 0-10 3.5-10 9 0 2 1 4 3 5 5.5 0 9-3.5 9-9 0-2-1-4-2-5Z" />
      <path d="M8 16c2.2-.5 4.6-2.2 6.5-5" />
    </>
  ),
  paw: (
    <>
      ...
      <path d="M8.5 15.5c0-2 1.6-3.5 3.5-3.5s3.5 1.5 3.5 3.5c0 1.4-1.1 2.5-2.5 2.5h-2c-1.4 0-2.5-1.1-2.5-2.5Z" />
    </>
  ),
  users: (
    <>
      ...
      <path d="M14.5 18a3.4 3.4 0 0 1 4-2.2" />
    </>
  ),
  heart: (
    <>
      <path d="M12 19s-6.5-4.1-6.5-9a3.7 3.7 0 0 1 6.5-2.4A3.7 3.7 0 0 1 18.5 10c0 4.9-6.5 9-6.5 9Z" />
    </>
  ),
  laptop: (
    <>
  ...
  pool: (
    <>
      <path d="M4 17c1 .8 2 .8 3 0s2-.8 3 0 2 .8 3 0 2-.8 3 0 2 .8 3 0" />
      <path d="M8 14V7a2 2 0 0 1 4 0v7" />
      <path d="M8 10h4" />
    </>
  ),
  sparkles: (
    <>
      ...
      <path d="m18 4 .5 1.5L20 6l-1.5.5L18 8l-.5-1.5L16 6l1.5-.5Z" />
      <path d="m6 14 .7 2L9 16.7 7 17.4 6.3 19 5.6 17.4 4 16.7 5.6 16Z" />
    </>
  ),
  celebration: (
    <>
      <path d="M8 6.5h8l-2 5.5h-4Z" />
      <path d="M10 12 7 18" />
      <path d="M14 12 17 18" />
      <path d="M6 8.5 4.5 7M18 8.5 19.5 7M12 4V2.5" />
    </>
  ),
  sprout: (
    <>
      <path d="M12 20v-7" />
      <path d="M12 13c0-3-2.1-5-5.5-5 0 3 2 5 5.5 5Z" />
      <path d="M12 11c0-2.7 1.9-4.5 5-4.5 0 2.7-1.8 4.5-5 4.5Z" />
    </>
  ),
  "map-pin": (
    <>
      <path d="M12 20s-5.5-5-5.5-10A5.5 5.5 0 1 1 17.5 10c0 5-5.5 10-5.5 10Z" />
  ...
  star: (
    <>
      <path d="m12 4 2.1 4.4 4.9.7-3.5 3.4.8 4.9L12 15.6 7.7 18l.8-4.9L5 9.7l4.9-.7Z" />
    </>
  ),
  utensils: (
    <>
      ...
      <path d="M8 11v9" />
      <path d="M15 4v6c0 1.1-.9 2-2 2h0v8" />
      <path d="M17 4v16" />
    </>
  ),
};
...
function CategoryIcon({ name, className = "h-5 w-5" }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {categoryIconMap[name] || categoryIconMap.building}
    </svg>
  );
}
...
const categoryTranslations = {
  en: {
    ...
    more: "More",
    collapse: "Show Less",
    empty: "Matching hotels for this category will appear here soon.",
  },
  ko: {
    title: "카테고리로 호텔 찾기",
  ...
  ja: {
    ...
    more: "もっと見る",
    collapse: "閉じる",
    empty: "このカテゴリーに対応するホテルはまもなく表示されます。",
  },
};
...
export default function MainPortal() {
  ...
  useEffect(() => {
    ...
    const hotelCodeFromReturn = urlParams.get('hotel_code') || '';

    const handlePortalBookingReturn = async () => {
      const bookingHotelCode = hotelCodeFromReturn || sessionStorage.getItem('nplus_portal_booking_hotel_code') || '';
      const resIdList = String(resIds || '').split(',').map(id => id.trim()).filter(Boolean);
      const syncReference = invoice || resIds || bookingHotelCode || 'N/A';

      if (resIdList.length > 0 && bookingHotelCode) {
        try {
          const response = await fetch('/api/public/reservations/confirm-paid-return', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ res_ids: resIdList, hotel_code: bookingHotelCode, invoice })
          });
          const result = await response.json().catch(() => ({}));

          if (!response.ok || result?.success === false) {
            throw new Error(result?.message || 'Reservation confirmation sync failed.');
          }
        } catch (err) {
          console.error('Portal payment return confirmation failed:', err);
          setAlertMessage(`Payment was completed, but reservation sync is still pending. Ref: ${syncReference}`);
        }
      } else {
        setAlertMessage(`Payment was completed, but reservation sync data was missing. Ref: ${syncReference}`);
      }

      setActiveView("HOME");
      setModalResId(resIds);
      setShowBookingSuccessModal(true);
      sessionStorage.removeItem('nplus_portal_booking_hotel_code');
    };
    ...
    if (paymentStatus === 'success') {
      if (type === 'saas' || action === 'register') {
        ...
        void handlePortalBookingReturn();
      }

      window.history.replaceState(null, '', window.location.pathname);
    }
    else if (paymentStatus === 'cancel' && type === 'booking') {
      setActiveView("HOME");
      setAlertMessage("Payment was cancelled. Your reservation was not confirmed.");
      sessionStorage.removeItem('nplus_portal_booking_hotel_code');
      window.history.replaceState(null, '', window.location.pathname);
    }
  ...
  const handleCategorySectionToggle = (sectionId) => {
  ...
  const renderCategoryCard = (category) => {
    ...
    return (
      <button
        ...
        className={`group flex aspect-square flex-col items-center justify-center rounded-xl border px-1.5 py-2 text-center transition-all duration-200 md:aspect-auto md:min-h-[124px] md:rounded-2xl md:px-2 md:py-3 ${
          isActive
      ...
      >
        <span
          className={`mx-auto mb-1 flex h-7 w-7 items-center justify-center rounded-xl transition-colors md:mb-2 md:h-10 md:w-10 md:rounded-2xl ${
            isActive
              ? "bg-emerald-100 text-emerald-600"
              : "bg-slate-100 text-slate-500 group-hover:bg-emerald-100 group-hover:text-emerald-600"
          }`}
        >
          <CategoryIcon name={category.icon} className="h-3.5 w-3.5 md:h-5 md:w-5" />
        </span>
        <span className="block min-h-[1.75rem] text-[8px] font-black leading-tight text-slate-800 line-clamp-2 md:min-h-[2.4rem] md:text-xs">
          {category.label}
        </span>
        <span className="mt-0.5 block text-[7px] text-slate-500 md:mt-1 md:text-[10px]">
    ...
    <main className="min-h-screen bg-slate-50 flex flex-col items-center justify-start overflow-x-hidden font-sans">
      ...
      {searchData ? (
        ...
        <div className="w-full flex-grow flex flex-col items-center animate-fade-in">
          <section className="relative mt-[72px] flex min-h-[68vh] w-full flex-col items-center justify-start pt-6 pb-10 md:min-h-[82vh] md:justify-center md:pt-0 md:pb-6">
            ...
            <div className="relative z-10 mt-2 max-w-5xl px-4 text-center md:mt-0">
              <div className="mb-4 inline-block rounded-full border border-emerald-500/50 bg-emerald-500/20 px-4 py-1.5 text-xs font-bold tracking-widest text-emerald-300 md:mb-6 md:text-sm">
                {t.heroBadge}
              </div>
              <h1 className="mb-4 text-4xl font-black leading-tight tracking-tight text-white drop-shadow-2xl md:mb-6 md:text-6xl lg:text-7xl">
                {t.heroTitle}
              </h1>
              <p className="mx-auto mb-6 max-w-3xl text-lg font-light leading-relaxed text-slate-300 drop-shadow md:mb-8 md:text-xl">
                {t.heroDesc}
              </p>
            </div>

            <div id="portal-booking-bar" className="relative z-[60] mt-4 -mb-10 w-full max-w-6xl px-4 md:mt-12 md:-mb-24">
          ...
          {categorySections.length > 0 && (
            <section className="w-full bg-slate-50 px-3 pt-8 pb-2 md:px-6 md:pt-20 md:pb-6">
              <div className="max-w-6xl mx-auto">
                <div className="rounded-[28px] border border-slate-200 bg-white p-4 shadow-xl md:rounded-[32px] md:p-8">
                  ...
                  <div className="space-y-4 md:space-y-5">
                    {categorySections.map((section) => (
                      <div key={section.id} className="space-y-2.5 md:space-y-3">
                        ...
                        <div className="grid grid-cols-5 gap-1.5 md:gap-3">
                          {(expandedCategorySections[section.id]
                            ? section.categories
                            : section.categories.slice(0, CATEGORY_PREVIEW_COUNT)
                          ).map((category) => renderCategoryCard(category))}
                          {section.categories.length > CATEGORY_PREVIEW_COUNT && (
                            <button
                              type="button"
                              onClick={() => handleCategorySectionToggle(section.id)}
                              className="group flex aspect-square flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 px-1.5 py-2 text-center transition-all duration-200 hover:border-emerald-300 hover:bg-emerald-50/70 md:aspect-auto md:min-h-[124px] md:rounded-2xl md:px-2 md:py-3"
                            >
                              <span className="mx-auto mb-1 flex h-7 w-7 items-center justify-center rounded-xl bg-white text-slate-500 shadow-sm transition-colors group-hover:bg-emerald-100 group-hover:text-emerald-600 md:mb-2 md:h-10 md:w-10 md:rounded-2xl">
                                <svg
                                  viewBox="0 0 24 24"
                                  fill="none"
                                  stroke="currentColor"
                                  ...
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                  className={`h-3.5 w-3.5 transition-transform md:h-5 md:w-5 ${expandedCategorySections[section.id] ? "rotate-180" : ""}`}
                                  aria-hidden="true"
                                >
                                  <path d="M12 5v14" />
                                  <path d="M5 12h14" />
                              ...
                              <span className="block min-h-[1.75rem] text-[8px] font-black leading-tight text-slate-800 line-clamp-2 md:min-h-[2.4rem] md:text-xs">
                                {expandedCategorySections[section.id] ? categoryT.collapse : categoryT.more}
                              </span>
                              <span className="mt-0.5 block text-[7px] text-slate-500 md:mt-1 md:text-[10px]">
                                {expandedCategorySections[section.id]
                                  ? `${section.categories.length} ${categoryT.tags}`
                      ...
                      <div className="overflow-hidden rounded-3xl border border-emerald-100 bg-emerald-50/40 shadow-sm">
                        <div className="flex flex-col gap-3 border-b border-emerald-100 bg-white/80 px-4 py-4 md:flex-row md:items-center md:justify-between">
                          <div>
                            ...
                            <h5 className="mt-1 flex items-center gap-3 text-lg font-black text-slate-900">
                              <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-600">
                                <CategoryIcon name={activeCategory.icon} className="h-5 w-5" />
                              </span>
                        ...
                        <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 xl:grid-cols-3">
                          {activeCategory.hotels.length > 0 ? (
                            ...
                            <div className="col-span-full flex flex-col items-center justify-center rounded-2xl border border-dashed border-emerald-200 bg-white px-4 py-10 text-center">
                              <span className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600">
                                <CategoryIcon name={activeCategory.icon} className="h-6 w-6" />
                              </span>
                              <p className="text-sm font-bold text-slate-700">{categoryT.empty}</p>
                            </div>
                          )}
                        </div>
                      </div>
          ...
          <section className={`w-full bg-slate-50 px-4 pb-8 md:px-6 md:pb-12 ${categorySections.length > 0 ? "pt-3 md:pt-10" : "pt-20 md:pt-32 -mt-4 md:-mt-8"}`}>
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-1 flex gap-2 overflow-x-auto pb-4 md:mb-2 md:pb-6 scrollbar-hide">
            ...
            ${promoRegion === region
              ...
              <div className="flex overflow-x-auto gap-4 pb-3 snap-x scrollbar-hide px-1 md:gap-6 md:px-2 md:pb-6">
          ...
          <section className="w-full border-b border-slate-100 bg-white px-4 pt-10 pb-10 md:mt-20 md:px-6 md:pt-16 md:pb-16">
            <div className="max-w-7xl mx-auto">
              <div className="mb-8 text-center md:mb-12">
                <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-3 md:mb-4 tracking-tight">{t.whyChoose}</h2>
                <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
                  {t.whyDesc}
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 md:grid-cols-2 md:gap-6 lg:grid-cols-4 lg:gap-8">
                {t.saasFeatures.map((feat, idx) => (
                  <div key={idx} className="bg-slate-50 p-4 rounded-2xl border border-slate-100 hover:border-emerald-200 hover:shadow-xl transition-all duration-300 group flex flex-col items-center text-center md:p-6 lg:p-8 lg:rounded-3xl">
                    <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-3xl shadow-sm transition-transform group-hover:scale-110 md:mb-5 md:h-14 md:w-14 md:text-4xl lg:mb-6 lg:h-16 lg:w-16">
                      {feat.icon}
                    </div>
                    <h3 className="mb-2 text-sm font-black text-slate-800 transition-colors group-hover:text-emerald-600 md:text-lg lg:mb-3 lg:text-xl">{feat.title}</h3>
                    <p className="text-[11px] leading-relaxed text-slate-500 md:text-sm">{feat.desc}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="w-full max-w-7xl mx-auto px-4 pt-8 pb-8 md:px-6 md:pt-14 md:pb-12">
            <div className="mb-6 flex flex-col gap-4 md:mb-10 md:flex-row md:items-end md:justify-between">
              <div>
                <h2 className="mb-3 text-3xl font-black tracking-tight text-slate-900 md:mb-4 md:text-4xl">{t.partnerNetwork}</h2>
            ...
            <div className="relative group/slider">
              ...
              <div ref={sliderRef} className="flex overflow-x-auto gap-4 snap-x pb-4 pt-2 px-1 md:gap-6 md:px-2 md:pb-6 md:pt-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
