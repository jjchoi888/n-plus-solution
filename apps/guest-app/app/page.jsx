            ...
            <div className="fixed inset-0 bg-slate-50 z-[100] flex flex-col font-sans text-slate-700">
                ...
                <div className="flex-1 overflow-y-auto p-6 flex flex-col max-w-md mx-auto w-full pb-20">
                    ...
                    {onboardStep === 4 && (
                        <div className="animate-fade-in-up space-y-5">
                            <div className="text-center mb-4">
                                ...
                                <p className="text-xs font-medium text-slate-500 mt-1">Create a 4-digit PIN to protect your rewards and personal data.</p>
                            </div>
                    ...
                    <div className="pt-6 shrink-0 border-t border-slate-100 mt-4">
                        <button onClick={nextStep} className="w-full bg-[#009900] hover:bg-[#008000] text-white py-4 font-bold text-base shadow-lg transition-transform active:scale-95 rounded-xl flex justify-center items-center gap-2">
                            {onboardStep === 4 ? 'Submit Application ✓' : 'Next Step ➔'}
                        </button>

                        {/* 💡 [추가됨] 2단계 이상일 때만 나타나는 이전 단계 버튼 */}
                        {onboardStep > 1 && (
                            <button
                                onClick={() => setOnboardStep(onboardStep - 1)}
                                className="w-full mt-3 py-3 text-xs font-bold text-slate-500 hover:text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors"
                            >
