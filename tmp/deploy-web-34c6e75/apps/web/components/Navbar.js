...
export default function Navbar({
  ...
  const handleLookup = async (e) => {
    ...
    try {
      ...
      setLookupError(t.networkErr); // 💡 Translated Network Error
    } finally {
    ...
    <>
      <nav className="w-full flex justify-between items-center px-6 md:px-8 py-4 md:py-6 bg-white border-b border-gray-100 shadow-sm fixed top-0 z-50">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {/* ======================================================== */}
          {/* 💡 [NEW] Guest Login / My Page Buttons mapped from guest-app */}
          {/* ======================================================== */}
          {user ? (
            <div className="flex items-center gap-2 md:gap-3 ml-1 md:ml-2">
              ...
              <button
                onClick={() => onMenuClick && onMenuClick('MYPAGE')} // 💡 Now directly navigates to My Page instead of alert
