  ...
  const renderCategoryCard = (category) => {
    ...
    return (
      <button
        ...
        className={`group rounded-2xl border px-2 py-3 text-center transition-all duration-200 min-h-[108px] md:min-h-[124px] ${
          isActive
      ...
      >
        <span
          className={`mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-2xl transition-colors md:h-10 md:w-10 ${
            isActive
              ? "bg-emerald-100 text-emerald-600"
              : "bg-slate-100 text-slate-500 group-hover:bg-emerald-100 group-hover:text-emerald-600"
          }`}
        >
          <CategoryIcon name={category.icon} className="h-4 w-4 md:h-5 md:w-5" />
        </span>
        <span className="block min-h-[2.4rem] text-[10px] md:text-xs font-black leading-tight text-slate-800 line-clamp-2">
          {category.label}
        </span>
        <span className="mt-1 block text-[9px] md:text-[10px] text-slate-500">
      ...
      {searchData ? (
        ...
        <div className="w-full flex-grow flex flex-col items-center animate-fade-in">
          ...
          {categorySections.length > 0 && (
            <section className="w-full bg-slate-50 px-4 pt-16 pb-6 md:px-6 md:pt-28 md:pb-8">
              <div className="max-w-6xl mx-auto">
                <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-xl md:rounded-[32px] md:p-8">
                  <div className="mb-5">
                        ...
                        <div className="grid grid-cols-5 gap-2 md:gap-3">
                          ...
                          {section.categories.length > CATEGORY_PREVIEW_COUNT && (
                            <button
                              ...
                              className="group rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-2 py-3 text-center transition-all duration-200 min-h-[108px] hover:border-emerald-300 hover:bg-emerald-50/70 md:min-h-[124px]"
                            >
                              <span className="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-2xl bg-white text-slate-500 shadow-sm transition-colors group-hover:bg-emerald-100 group-hover:text-emerald-600 md:h-10 md:w-10">
                                <svg
                                  viewBox="0 0 24 24"
                                  fill="none"
                                  stroke="currentColor"
                                  ...
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                  className={`h-4 w-4 transition-transform md:h-5 md:w-5 ${expandedCategorySections[section.id] ? "rotate-180" : ""}`}
                                  aria-hidden="true"
                                >
                                  <path d="M12 5v14" />
                                  <path d="M5 12h14" />
          ...
          <section className={`w-full bg-slate-50 px-6 pb-16 ${categorySections.length > 0 ? "pt-10 md:pt-14" : "pt-32 md:pt-40 -mt-8"}`}>
